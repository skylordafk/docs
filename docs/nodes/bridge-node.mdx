...
```sh
celestia bridge init --core.ip rpc-mocha.pops.one
```
...
```sh
celestia bridge init --core.ip consensus-validator.celestia-arabica-10.com --p2p.network arabica
```
...
```sh
celestia bridge start --core.ip consensus-validator.celestia-arabica-10.com --p2p.network arabica
```
